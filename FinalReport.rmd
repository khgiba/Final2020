...
```{r}
DataDrugUser = filter(FinalData,DrugUser=="no")
barchartGC(~infected + treatment,data=DataDrugUser)
barchartGC(~infected + treatment,data=DataDrugUser, type="percent",main="drugs")

```
  
Among the people who take drugs and was given the vaccine it appears that there is a negative response and are likely to get Covid.      
